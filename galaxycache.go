...
// one cache fill.
package galaxycache // import "github.com/localrivet/galaxycache"
...
import (
	...
	"github.com/localrivet/galaxycache/lru"
	"github.com/localrivet/galaxycache/promoter"
	"github.com/localrivet/galaxycache/singleflight"
...
func (g *Galaxy) Remove(ctx context.Context, key string) error {
	...
	_, err := g.removeGroup.Do(key, func() (interface{}, error) {
		...
		for _, peer := range g.peerPicker.GetAll() {
...
func (g *Galaxy) removeFromPeer(ctx context.Context, peer RemoteFetcher, key string) error {
...
func (g *Galaxy) localRemove(key string) {
